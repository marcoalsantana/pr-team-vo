...
/* ---------- Página: Pré-Treino de Inferiores ---------- */
export default function InferioresPage() {
  const router = useRouter();

  const items = useMemo(() => ([
    { titulo: 'Alongamento 1', url: 'https://www.youtube.com/shorts/35a6ajtAu9I' },
    { titulo: 'Alongamento 2', url: 'https://www.youtube.com/shorts/UxYkX9ZI9Vo' },
    { titulo: 'Alongamento 3', url: 'https://www.youtube.com/shorts/1scceZZZnwU' },
    { titulo: 'Alongamento 4', url: 'https://www.youtube.com/shorts/_whe3mNiVko' },
    { titulo: 'Mobilidade 1', url: 'https://www.youtube.com/shorts/yDZYnZemKF0' },
    { titulo: 'Mobilidade 2', url: 'https://www.youtube.com/shorts/6nztr01LPz8' },
  ]), []);
